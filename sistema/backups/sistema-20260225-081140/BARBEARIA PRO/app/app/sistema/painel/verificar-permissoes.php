...
if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_home', true)){
	$home = 'ocultar';
}

if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_configuracoes', true)){
	$configuracoes = 'ocultar';
}

if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_pessoas', true)){
	$usuarios = 'ocultar';
	$funcionarios = 'ocultar';
	$clientes = 'ocultar';
	$clientes_retorno = 'ocultar';
...
if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_cadastros', true)){
	$servicos = 'ocultar';
	$cargos = 'ocultar';
	$cat_servicos = 'ocultar';
	$grupos = 'ocultar';
...
if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_produtos', true)){
	$produtos = 'ocultar';
	$cat_produtos = 'ocultar';
	$estoque = 'ocultar';
	$saidas = 'ocultar';
...
if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_financeiro', true)){
	$vendas = 'ocultar';
	$compras = 'ocultar';
	$pagar = 'ocultar';
	$receber = 'ocultar';
...
if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_agendamentos', true)){
	$agendamentos = 'ocultar';
	$servicos_agenda = 'ocultar';
}

if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_relatorios', true)){
	$rel_produtos = 'ocultar';
	$rel_entradas = 'ocultar';
	$rel_saidas = 'ocultar';
	$rel_comissoes = 'ocultar';
...
if(!saas_plano_recurso_permitido($saas_plano_ctx, 'menu_site', true)){
	$textos_index = 'ocultar';
	$comentarios = 'ocultar';
}
...
if($rel_produtos == 'ocultar' and $rel_lucro == 'ocultar' and $rel_aniv == 'ocultar' and $rel_contas == 'ocultar' and $rel_comissoes == 'ocultar' and $rel_saidas == 'ocultar' and $rel_entradas == 'ocultar'){

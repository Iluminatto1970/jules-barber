...
class CatProdutosCrud extends CRUD_Template {
    protected $tableName = 'cat_produtos';
    protected $primaryKey = 'id';
    protected $title = 'Categorias de Produtos';
    protected $singular = 'Categoria de Produto';
    protected $plural = 'Categorias de Produtos';
    protected $modulePath = 'cat_produtos';

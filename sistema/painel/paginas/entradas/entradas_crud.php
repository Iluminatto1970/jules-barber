...
class EntradasCrud extends CRUD_Template {
    protected $tableName = 'entradas';
    protected $primaryKey = 'id';
    protected $title = 'Entradas de Estoque';
    protected $singular = 'Entrada';
    protected $plural = 'Entradas';
    protected $modulePath = 'entradas';

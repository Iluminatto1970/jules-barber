...
saas_plano_exigir_ativo($saas_plano_ctx, $pdo_saas, $empresa_id, 'produtos/salvar');
saas_plano_exigir_recurso($saas_plano_ctx, 'menu_produtos', 'Seu plano nao permite gerenciar produtos.', $pdo_saas, $empresa_id);
...
if($id == ""){
	saas_plano_exigir_limite_total_tabela($pdo, $saas_plano_ctx, 'limite_produtos', 'produtos', 'Limite de produtos do plano atingido.', '1=1', $pdo_saas, $empresa_id);
}

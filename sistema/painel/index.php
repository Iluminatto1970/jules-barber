...
$saas_alerta_plano = '';
if(!empty($_SESSION['saas_checkout_msg'])){
	$saas_alerta_plano = $_SESSION['saas_checkout_msg'];
	unset($_SESSION['saas_checkout_msg']);
}

$assinatura_bloqueada = !empty($saas_plano_ctx['bloqueada']);
if($assinatura_bloqueada && $pag != 'assinatura_saas'){
	$pag = 'assinatura_saas';
	$saas_alerta_plano = $empresa_assinatura_motivo != '' ? $empresa_assinatura_motivo : 'Sua assinatura esta bloqueada. Regularize para continuar.';
}

$recurso_pagina = saas_plano_mapear_pagina_recurso($pag);
if($recurso_pagina != '' && !saas_plano_recurso_permitido($saas_plano_ctx, $recurso_pagina, true)){
	$saas_alerta_plano = 'Seu plano atual nao permite acessar este modulo.';
	$pag = 'home';
}
...
<head>
	...
	<base href="<?php echo $url_sistema ?>sistema/painel/">
	...
	<!-- Custom CSS - Novo Design -->
	<link href="css/style-novo.css" rel='stylesheet' type='text/css' />
	<!-- CSS Antigo como fallback -->
	<link href="css/style.css" rel='stylesheet' type='text/css' />
	<!-- CSS Override para garantir aplicação dos estilos -->
	<link href="css/override.css?v=<?php echo (int) @filemtime(__DIR__ . '/css/override.css'); ?>" rel='stylesheet' type='text/css' />
	<!-- Ajustes responsivos complementares -->
	<link href="css/responsive-overrides.css" rel='stylesheet' type='text/css' />
...
<body class="cbp-spmenu-push">
	<button type="button" id="showLeftPush" class="mobile-menu-toggle" aria-label="Abrir menu">
	...
	<div class="main-content">
		<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
			...
			<aside class="sidebar-left" style="height:100%;">
				<nav class="navbar navbar-inverse" >
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-cogs"></span> Painel<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview <?php echo @$menu_pessoas ?>">
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$clientes_retorno ?>"><a href="index.php?pag=clientes_retorno"><i class="fa fa-angle-right"></i>Clientes Retornos</a></li>
							...
							<li class="treeview <?php echo $pag == 'assinatura_saas' ? 'active' : '' ?>">
								<a href="index.php?pag=assinatura_saas">
							...
							<li class="treeview <?php echo @$menu_site ?>" >
								...
								<ul class="treeview-menu">
									...
									<li class="<?php echo @$textos_index ?>"><a href="index.php?pag=textos_index"><i class="fa fa-angle-right"></i>Textos Hero</a></li>


									<li class="<?php echo @$comentarios ?>"><a href="index.php?pag=comentarios"><i class="fa fa-angle-right"></i>Depoimentos</a></li>
							...
							<!-- Menu do Usuário -->
							<li class="treeview" style="border-top: 1px solid rgba(255,255,255,0.1); margin-top: 20px; padding-top: 15px;">
								<a href="#">
									<img src="img/perfil/<?php echo $foto_usuario ?>" alt="" width="25" height="25" style="border-radius: 50%; margin-right: 10px;"> 
								...
								<ul class="treeview-menu">
									...
									<li><a href="logout.php" onclick="return confirm('Deseja realmente sair do sistema?')"><i class="fa fa-sign-out"></i> Sair</a></li>
								</ul>
							</li>
		...
		<!-- main content start-->
		<div id="page-wrapper">
			<?php if($saas_alerta_plano != ''){ ?>
			<div class="alert alert-warning" style="margin-top: 10px;">
				<?php echo $saas_alerta_plano ?>
			</div>
			<?php } ?>

			<?php if($empresa_assinatura_status == 'Trial' && $empresa_assinatura_trial_ate != ''){ ?>
			<div class="alert alert-info" style="margin-top: 10px;">
				Plano <?php echo $empresa_plano_nome ?> em Trial ate <?php echo implode('/', array_reverse(explode('-', $empresa_assinatura_trial_ate))) ?>.
				<a href="index.php?pag=assinatura_saas" class="btn btn-xs btn-primary" style="margin-left: 10px;">Gerenciar assinatura</a>
			</div>
			<?php } ?>

			<?php if($empresa_assinatura_status == 'Ativa' && $empresa_assinatura_ciclo_ate != ''){ ?>
			<div class="alert alert-success" style="margin-top: 10px;">
				Plano <?php echo $empresa_plano_nome ?> ativo ate <?php echo implode('/', array_reverse(explode('-', $empresa_assinatura_ciclo_ate))) ?>.
				<a href="index.php?pag=assinatura_saas" class="btn btn-xs btn-default" style="margin-left: 10px;">Checkout PIX</a>
			</div>
			<?php } ?>
	...
	<!-- Classie --><!-- for toggle left push menu script -->
		...
		<script>
			...
			function syncMobileOverlay() {
				if (!mobileOverlay || !menuLeft) {
					return;
				}

				if (window.innerWidth <= 768 && menuLeft.classList.contains('cbp-spmenu-open')) {
			...
			window.addEventListener('resize', function() {
				if (window.innerWidth > 768 && menuLeft) {
